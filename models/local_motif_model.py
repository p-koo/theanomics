...
def model(shape, num_labels):
	...
	net['conv1_pool'] = layers.MaxPool2DLayer(net['conv1_active'], pool_size=(40, 1), stride=(40, 1), ignore_border=False) # 17
	net['conv1_dropout'] = layers.DropoutLayer(net['conv1_pool'], p=0.1)

	net['conv2'] = layers.Conv2DLayer(net['conv1_dropout'], num_filters=64, filter_size=(8, 1), stride=(1, 1), # 20
	...
	net['conv2_pool'] = layers.MaxPool2DLayer(net['conv2_active'], pool_size=(18, 1), stride=(18, 1), ignore_border=False) # 3
