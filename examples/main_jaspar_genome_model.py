...
nnmodel = fit.train_valid_minibatch(nnmodel, train, valid, batch_size, 
				num_epochs=5, patience=0, verbose=1, filepath=filepath)
...
nnmodel = fit.anneal_train_valid_minibatch(nnmodel, train, valid, batch_size, 
