...
class train:
    def __init__(NeuralNetworkModel, batch_size, num_epochs, patience, save, filepath, verbose):
        
        self.network = NeuralNetworkModel.get_network()
        self.train_fun = NeuralNetworkModel.get_train_function()
        self.test_fun = NeuralNetworkModel.get_test_function()
