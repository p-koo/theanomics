...
train, valid, test = load_MotifSimulation(filename, dirpath, categorical=categorical)
...
nnmodel.train(train, valid, test, batch_size=500, num_epochs=500, patience=3, save=save, filepath=filepath, verbose=1)
